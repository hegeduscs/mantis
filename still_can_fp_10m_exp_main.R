...
#megoldom az átnevezést  (kicserélem angol oszlopnevekre)

#finomhangolom a filterezést/select-et 
#(a nem releváns oszlopokból nem tartok meg adatot )
#összevonom az időt egy oszloppá
#automatizálom 1 fingerprintre
#automatizálom az összesre (csak a kis fileok)
